    ...
    <div className="px-4 py-8 md:py-12">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 dark:from-white dark:via-gray-200 dark:to-white bg-clip-text text-transparent" data-translate>
            Choose Your Plan
          </h1>
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto" data-translate>
        ...
        <div className="mt-8 grid gap-8 md:grid-cols-2 lg:gap-12">
          ...
          <div className="relative group">
            ...
            <div className="relative h-full bg-white dark:bg-gray-900 rounded-xl p-8">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h3 className="text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text text-transparent" data-translate>
                    Free Plan
                  </h3>
                  <p className="text-gray-600 dark:text-gray-400 mt-2" data-translate>Perfect for getting started</p>
                </div>
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700 dark:text-gray-300" data-translate>Five Course Limit</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="flex-shrink-0 w-6 h-6 flex items-center justify-center rounded-full bg-[#F0D5FF] dark:bg-[#635AE5] bg-opacity-30">
                    <Check className="w-4 h-4 text-[#635AE5] dark:text-white" />
                  </div>
                  <span className="text-gray-700 dark:text-gray-300" data-translate>Unlimited Notes Taking</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="flex-shrink-0 w-6 h-6 flex items-center justify-center rounded-full bg-[#F0D5FF] dark:bg-[#635AE5] bg-opacity-30">
                    <Check className="w-4 h-4 text-[#635AE5] dark:text-white" />
                  </div>
                  <span className="text-gray-700 dark:text-gray-300" data-translate>Email Support</span>
                </li>
              </ul>
              ...
              <button className="w-full py-3 rounded-lg border-2 border-[#E5DBFF] dark:border-[#635AE5] text-gray-900 dark:text-white font-medium transition-all hover:bg-[#F0D5FF] hover:border-[#F0D5FF] dark:hover:bg-[#635AE5] dark:hover:border-[#635AE5]">
                <span data-translate>Current Plan</span>
              </button>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="relative h-full bg-gradient-to-r from-[#F5F7FF] to-[#FAFBFF] dark:from-gray-900 dark:to-gray-800 rounded-xl p-8">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mt-2" data-translate>For power users</p>
                </div>
                <Sparkles className="w-10 h-10 text-[#E5DBFF] dark:text-[#635AE5]" />
              </div>
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700 dark:text-gray-300" data-translate>Unlimited Course Creation</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="flex-shrink-0 w-6 h-6 flex items-center justify-center rounded-full bg-[#F0D5FF] dark:bg-[#635AE5] bg-opacity-30">
                    <Check className="w-4 h-4 text-[#635AE5] dark:text-white" />
                  </div>
                  <span className="text-gray-700 dark:text-gray-300" data-translate>Priority Support</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="flex-shrink-0 w-6 h-6 flex items-center justify-center rounded-full bg-[#F0D5FF] dark:bg-[#635AE5] bg-opacity-30">
                    <Check className="w-4 h-4 text-[#635AE5] dark:text-white" />
                  </div>
                  <span className="text-gray-700 dark:text-gray-300" data-translate>Advanced Features</span>
                </li>
              </ul>
              ...
              {userDetails?.isMember == false ? (
                ...
                <button
                  ...
                  className="w-full py-3 rounded-lg bg-gradient-to-r from-[#E5DBFF] via-[#F0D5FF] to-[#F7E6FF] dark:from-[#4B47B3] dark:via-[#635AE5] dark:to-[#8E5AED] text-gray-900 dark:text-white font-medium transition-all hover:opacity-90 hover:scale-[1.02]"
                >
                  <span data-translate>Manage Subscription</span>
                </button>
              )}
            </div>
          </div>
